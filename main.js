...
document.getElementById("givenSketch").innerHTML = "Sketch To Be Drawn: " + Element_of_array ;
...
function check_sketch(){
    timer_counter++
    document.getElementById("timer").innerHTML = "Time Elasped : " + timer_counter;
...
function updateCanvas(){
    background("White");
    sketch = Element_of_array;
    document.getElementById("givenSketch").innerHTML = "Sketch To Be Drawn: " + sketch ;
};